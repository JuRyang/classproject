...
public class FriendInfoHandler {
	...
	private int numOfFriends = 0;    //저장된 친구의 정보 개수,배열의 요소 추가시 index로 사용
	...
	void addFriend(int choice) {
		...
		System.out.println("친구정보의 입력을 시작합니다.");
	...
	public void showAllData() {
		...
		for(int i=0; i<numOfFriends; i++) {
			...
			friends[i].showData();//frieds[0] -> Friend타입의 참조변수이다 = 하위클래스의 인스턴스들을 참조
			System.out.println("--------------------------");
