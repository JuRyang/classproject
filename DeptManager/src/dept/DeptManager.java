...
public class DeptManager {
	...
	//부서 정보 수정 메서드: 사용자에게 입력 받고 데이터를 DAO 이용해서 수정
	void editDept() {
	...
	void listDept() {
		   ...
		   Connection conn = null;
			...
			//	dept= dao.listDept(Integer.parseInt(deptno), conn);
	...
	void searchDept() {
		...
		if(dept!=null) {
			...
			System.out.println("찾으시는 정보가 존재하지않습니다.");
		}
