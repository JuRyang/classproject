...
설명: 구매자의 객체를 정의
작성일시:2020.10.08
수정내용: fruti.FruitBuyer.java를 기반으로 생성자를 추가
*/
...
public class FruitBuyer {
	...
	//현재상태(금액, 사과의 개수 ) 값을 출력
	void showBuyResult() {
		System.out.println("보유금액:"+myMoney);
		System.out.println("보유한 사과 의 개수"+numOfapple);
