...
public class ArrayTest {
	...
	/*	int[] arr = null;
		...
		//배열의 참조: 입력, 읽기
		//배열이름[index]:배열의 변수는 순차적으로 위치하기 때문에 index값으로 참조.
		...
		int[] arr4 = {1,2,3,4,5}; //원본 데이터, 주소값: 0x100-> 메모리생성(ㅁㅁㅁㅁㅁ)->array4
		int[] ref;
	...
	//int타입의 배열을 받고,증가시킬 정수 값을 받아서
	//각 배열의 요소에 받은 정수 값 만큼 증가시키고 
	//전달 받은 배열을 반환
	...
	//로또 번호 축출 프로그램
	//정수 데이터 1~45까지 숫자를 저장하는 변수 45개 셍성 -> int타입의 배열 선언, 생성
