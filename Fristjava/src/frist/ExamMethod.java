...
//2020.10.13 메서드 문제풀이
	...
	원의 둘레를 계산해서 반환(반환타입 정해야함)하는 메서드를 각각 정의하고, (2*π*r)
	이를 호출하는 main메서드를 정의하자. (2*π*r), (π*r∧2)   π->double형 실수 
	*/ 
	...
	static void abs(int num1, int num2) {
		System.out.println("num1의 절대값:"+(num1>0?num1:num1*-1)); //절대값 구하는 식
		System.out.println("num1의 절대값:"+(num2>0?num2:-num2));
	}
